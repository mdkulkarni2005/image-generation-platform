...
-- CreateEnum
CREATE TYPE "EthicityEnum" AS ENUM ('White', 'Black', 'Asian', 'Hispanic', 'MiddleEastern', 'NativeAmerican', 'PacificIslander', 'Other');

-- CreateEnum
CREATE TYPE "EyeColorEnum" AS ENUM ('Brown', 'Blue', 'Green', 'Gray', 'Hazel', 'Amber', 'Red', 'Other');
...
CREATE TABLE "Model" (
    ...
    "ehinicity" "EthicityEnum" NOT NULL,
